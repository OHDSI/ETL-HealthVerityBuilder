...
#' Run the query to create the procedure_occurrence table.
#'
#' This function will call and run the sql file to create the procedure_occurrence table from the STEM table.
...
createProcedureOccurrenceTable <- function(connectionDetails,
                                           cdmDatabaseSchema,
                                           oracleTempSchema = NULL){

  conn <- connect(connectionDetails)
  sqlFile <- "ProcedureOccurrenceTable.sql"

  print(paste0("Run procedure_occurrence table"))
