...
#' Run the query to create the drug_exposure table.
#'
...
createDrugExposureTable <- function(connectionDetails,
                                           cdmDatabaseSchema,
                                           oracleTempSchema = NULL){

  conn <- connect(connectionDetails)
  sqlFile <- "DrugExposureTable.sql"

  print(paste0("Run drug_exposure table"))
