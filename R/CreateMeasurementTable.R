...
#' Run the query to create the measurement table.
#'
#' This function will call and run the sql file to create the measurement table from the STEM table.
...
createMeasurementTable <- function(connectionDetails,
                                    cdmDatabaseSchema,
                                    oracleTempSchema = NULL){

  conn <- connect(connectionDetails)
  sqlFile <- "MeasurementTable.sql"

  print(paste0("Run measurement table"))
