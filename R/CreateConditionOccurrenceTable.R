...
#' Run the query to create the condition_occurrence table.
#'
#' This function will call and run the sql file to create the condition_occurrence table from the STEM table.
...
createConditionOccurrenceTable <- function(connectionDetails,
                                       cdmDatabaseSchema,
                                       oracleTempSchema = NULL){

    conn <- connect(connectionDetails)
    sqlFile <- "ConditionOccurrenceTable.sql"

      print(paste0("Run condition_occurrence table"))
