...
#' Run the query to create the device_exposure table.
#'
#' This function will call and run the sql file to create the device_exposure table from the STEM table.
...
createDeviceExposureTable <- function(connectionDetails,
                                           cdmDatabaseSchema,
                                           oracleTempSchema = NULL){

  conn <- connect(connectionDetails)
  sqlFile <- "DeviceExposureTable.sql"

  print(paste0("Run device_exposure table"))
